package day09;
//MyInter를 상속 받아서 에러나지 않게 철해보세요.
//인터페이스는 implements로 상속받는다.

//YourInter도 상속받아 에러나지 않게 처리해 보세요

public class MyClass implements MyInter, YourInter {//다중 상속 가능
	@Override
	public void demo() {
...
public static void main(String[]args) {
	...
	//인터페이스도 타입 선언은 할 수있으나
	//new를 사용하여 객체 생성은 할 수 없다.
